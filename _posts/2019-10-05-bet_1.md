...
Medir a área superficial e o tamanho dos poros de um material em pó é uma tarefa consideravelmente difícil. Dentre as poucas técnicas disponíveis para tal missão, a mais amplamente utilizada é a adsorção de gases no sólido e a aplicação da teoria de BET.

O método de BET [1], desenvolvido por Stephen **B**runauer, Paul Hugh **E**mmett e Edward **T**eller, é um método um método para tratar dados de adsorção de gases (em geral N<sub>2</sub>, mas pode ser estendido para virtualmente qualquer gás) e obter informações acerca da área específica de materiais porosos. Ela permite a determinação da área específica, externa e interna, de um sólido poroso disperso através da medição da quantidade de gás fisicamente adsorvido e extrapolação do volume referente a uma monocamada de gás nessa superfície.  
