...
O método de BET [1], desenvolvido por Stephen **B**runauer, Paul Hugh **E**mmett e Edward **T**eller, é um método um método para tratar dados de adsorção de gases (em geral N<sup>2</sup>, mas pode ser estendido para virtualmente qualquer gás) e obter informações acerca da área específica de materiais porosos. ****
...
O arquivo disponibilizado [aqui]() contém os dados de adsorção de $$N_2$$ a 77K em um material nanoporoso. Para esse material, considere $$p_0 = 765.23$$ mmHg e $$m = 0.0142 \pm 0.0005$$ g. Os dados são os valores originais, o volume adsorvido está em unidades de $$cm^3$$ e a pressão em mmHg.
...
<img src="{{ site.url }}{{ site.baseurl }}/images/posts/BET/isoterma.png" alt="Isoterna de N2" width="100%" height="100%">

**Figura 1:** Isoterma de adsorção de N<sup>2</sup> a 77K em material microporoso carbonáceo.
...
<img src="{{ site.url }}{{ site.baseurl }}/images/posts/BET/bet.png" alt="Linearização BET dos dados" width="100%" height="100%">

**Figura 2:** Gráfico de BET

> Com base nos parâmetros do ajuste linear, determine a área específica deste material em unidades de $$m^2/g$$. Utilize $$\sigma_{N_2} = 16.2$ \AA{}$^2$$. Considerando a incerteza da medida da massa, qual a incerteza da área específica? Com base na constante $$c$$, que conclusões podemos tirar?
