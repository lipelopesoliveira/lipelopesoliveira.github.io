...
<img src="{{ site.url }}{{ site.baseurl }}/images/posts/tutorial_qe/bravais.jpg" alt="Redes de Bravais">
  * \textbf{nat}: Número total de átomos na célula unitária;
  * \textbf{ntyp}: Número de tipos de átomos diferentes;
  * \textbf{ecutwfc}: Energia de corte das funções de onda em Ry;
  * \textbf{ecutrho}: Energia de corte da densidade de carga.
