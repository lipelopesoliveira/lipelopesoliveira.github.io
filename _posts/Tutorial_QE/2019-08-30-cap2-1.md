...
**Figura 1:** Energia em função da distância de ligação, $$E(d_{N-N})$$ para a molécula de $$N_2$$. Os pontos vermelhos são os valores calculados e a linha preta um ajuste de um potencial de Morse e a linha azul o ajuste de um potencial harmônico.
