...
Precisamos agora calcular os modos normais de vibração, para ter certeza que essa estrutura corresponde à um mínimo local ou é um ponto de cela. Basta executar um cálculo SCF com a estrutura em equilíbrio obtida e, em seguida, executar os scripts abaixo.
